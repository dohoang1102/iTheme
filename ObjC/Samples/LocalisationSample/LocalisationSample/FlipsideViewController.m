...
- (void)viewDidLoad
{
    ...
    [[ThemeFramework instance] browseThemes:self limit:LOCALISATIONS_TO_RETURN];
    [self changeTheme];
}
...
{
    [[ThemeFramework instance] browseThemes:self limit:LOCALISATIONS_TO_RETURN cursor:self.cursor];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImage *img = [self returnUIImage:theme keyName:@"promoItem.png"];
